      ...
      <div class="col-3 border-style">
        ...
        <section class="row justify-content-center">
          <div class="col-10 d-flex justify-content-between">
            ...
            <!-- TODO offcanvas form -->
            <button v-if="account.id" class="btn maroon fw-bold fs-4"  type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">Form Guild</button>
          </div>
